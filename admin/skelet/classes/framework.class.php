  ...
  class SkeletFramework extends SkeletFramework_Abstract {
    ...
    public function admin_menu() {
      ...
      if(!defined( 'SK_PARENT_MENU' )){
        ...
        call_user_func("add_menu_page", "Codrops", "Codrops", "pa-nonexistent-capability", SK_PARENT_MENU, null, $args['menu_icon'], $args['menu_position'] );
      }
    ...
    public function admin_page() {
      ...
      echo '<footer class="sk-footer">';
        echo '<a target="_blank" href="http://champ.ninja/">WP Codrops | Developed and Maintained by Champ Camba</a>';
