 ...
 * Add PressApps Menu
 */
if(!class_exists("Skelet_Champ_Menu")){

  class Skelet_Champ_Menu{

    public static function main_menu(){
        global $skelet_paths, $submenu;
      
         call_user_func("add_submenu_page", SK_PARENT_MENU, "Help", "Help", "manage_options", "champ-help", array("Skelet_Champ_Menu","get_champ_general_pages"));
         call_user_func("add_submenu_page", SK_PARENT_MENU, "Donate", "Donate", "manage_options", "champ-donate", array("Skelet_Champ_Menu","get_champ_general_pages"));
                          
   }
    public static function get_champ_general_pages(){
      if(!class_exists("ChampNinja"))
      {
            include_once wp_normalize_path(plugin_dir_path(__FILE__ ) .'/pressapps/champ.class.php');
            $pa = new ChampNinja;
     ...
     add_action("admin_menu",array("Skelet_Champ_Menu","main_menu"),999);
